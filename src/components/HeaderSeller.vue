<template>
  <header id="mainHeader" class="bg-gradient-to-r from-red-600 to-black p-4 text-white fixed top-0 left-0 right-0 z-40">
...
export default {
  ...
  data() {
    return {
      ...
      storeName: '',
      apiUrls: [
        'http://127.0.0.1:8000/api/seller/notifikasi/count',
        '/api/seller/notifikasi/count',
        'http://localhost:8000/api/seller/notifikasi/count'
      ]
    };
  },
  methods: {
