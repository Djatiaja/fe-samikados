    ...
    <main class="container mx-auto flex flex-col lg:flex-row lg:justify-evenly lg:items-center lg:justify-center flex-grow">
      ...
      <section class="w-full lg:w-1/3 bg-white p-8 shadow-xl rounded-lg">
        ...
        <div class="mb-4 relative">
          <input v-model="newPassword" :type="showPassword ? 'text' : 'password'" class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-600 pr-10" placeholder="Password" />
        ...
        <div class="mb-4 relative">
          <input v-model="confirmPassword" :type="showPassword ? 'text' : 'password'" class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-600" placeholder="Konfirmasi Password" />
        </div>
        
        <p class="text-xs text-gray-500 mb-4">Password terdiri dari kombinasi huruf kecil, huruf besar, simbol, dan angka!</p>
